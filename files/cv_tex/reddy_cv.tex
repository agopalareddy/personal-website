...
\begin{leadershipentry}{CodeTillDawn Hackathon}{St. Louis, Missouri, USA}
...
\begin{leadershipentry}{Kaggle Agents for Good Hackathon}{Remote}
	\begin{positionentry}{\href{https://github.com/agopalareddy/wellness-companion}{AURA: Ambient Wellness Companion}}{June 2026}
		\item Built a privacy-first elderly wellness companion using Google ADK 2.0, orchestrating a multi-agent graph with medication extraction, empathetic check-in, privacy filtering, and escalation routing agents.
		\item Implemented deterministic privacy guard enforcing allowlist-only telemetry persistence and rule-based escalation for missed medication cycles or critical mood drops.
	\end{positionentry}
\end{leadershipentry}
