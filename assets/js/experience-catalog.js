...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function createExperienceCard(exp) {
    ...
    if (subtitleParts.length > 0) {
      subtitleHtml =
        '<div class="card-org-context" style="font-size: 0.8rem; color: var(--text-muted); margin-top: 0.1rem; margin-bottom: 0.8rem; font-family: var(--font-body); font-weight: 500; line-height: 1.4;">' +
        subtitleParts.join(' \u2022 ') +
        '</div>';
    }
