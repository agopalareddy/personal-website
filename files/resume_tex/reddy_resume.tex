...
\begin{experienceentry}
	...
	\item Designed and engineered the Figma-to-React UI for an upcoming all-in-one environmental sensor device, delivering a pixel-perfect, production-ready interface from initial wireframes.
\end{experienceentry}
